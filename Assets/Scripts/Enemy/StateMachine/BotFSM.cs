...
public enum States { Follow, Idle, Attack, Aim, Shoot, Die, None }
public class BotFSM : StateMachine
{
    ...
    [HideInInspector] public States firstState = States.None;
    [HideInInspector] public States secondState = States.None;
    private Enemy enemy;
    ...
    public void Attack()
    {
        ...
        if (attackState == null) { attackState = new Attack(this, enemy, animController, weapon); }
    ...
    public void Aim()
    {
        if (aimState == null) { aimState = new Aim(this, enemy, animController); }
    ...
    {
        if (inCooldown) return;
        if (shootState == null) { shootState = new Shoot(this, rangeWeapon, animController); }
    ...
    public void Die()
    {
        if (dieState == null) { dieState = new Die(this, enemy, animController); }
        if (firstState != States.Die)
        {
            PointsController.points += pointsValue;
            PointsController.kills++;
